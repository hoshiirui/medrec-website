<div class="app-sidebar">
    ...
    <div class="app-menu">
        <ul class="accordion-menu">
            ...
            <li>
                <a href="calendar.html"><i class="material-icons-two-tone">calendar_today</i>Laporan Kunjungan</a>
            </li>
            <li>
                <a href="todo.html"><i class="material-icons-two-tone">done</i>Help</a>
            </li>
            <li class="sidebar-title">
                UI Elements
            </li>
